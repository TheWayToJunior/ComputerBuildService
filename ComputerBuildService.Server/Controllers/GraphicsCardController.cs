...
namespace ComputerBuildService.Server.Controllers
{
    ...
    {
        private readonly IGraphicsCardService service;
        private readonly ILogger<GraphicsCardController> logger;

        public GraphicsCardController(IGraphicsCardService service, ILogger<GraphicsCardController> logger)
        {
